...
- elliptic: A preprocessed version of https://www.kaggle.com/ellipticco/elliptic-data-set can be obtained from [here](https://github.com/rosieiiiii/EvolveGCN/blob/master/Elliptic_EvolveGCN.ipynb).
